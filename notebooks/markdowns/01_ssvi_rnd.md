...
diag = pd.read_parquet(RES_P1 / 'ssvi_diagnostics.parquet')
...
```
    ...
    DER    1327.0  0.0260  0.0085  0.0091  0.0153  0.0203  0.0246  0.0295  0.0405   
...
![png](01_ssvi_rnd_files/01_ssvi_rnd_17_0.png)
