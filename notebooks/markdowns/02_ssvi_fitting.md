...
```
    ...
    C:\Users\Lucal\AppData\Local\Temp\ipykernel_47168\1706358996.py:3: MatplotlibDeprecationWarning: The 'labels' parameter of boxplot() has been renamed 'tick_labels' since Matplotlib 3.9; support for the old name will be dropped in 3.11.
      bp = ax.boxplot(data_box, labels=['CME', 'Deribit'], showfliers=True,
    


    
![png](02_ssvi_fitting_files/02_ssvi_fitting_3_1.png)
...
![png](02_ssvi_fitting_files/02_ssvi_fitting_5_0.png)
...
![png](02_ssvi_fitting_files/02_ssvi_fitting_7_0.png)
    



    
![png](02_ssvi_fitting_files/02_ssvi_fitting_7_1.png)
...
![png](02_ssvi_fitting_files/02_ssvi_fitting_10_0.png)
...
![png](02_ssvi_fitting_files/02_ssvi_fitting_14_0.png)
